...
def main():
    ...
    train_dir = os.path.join(base_dir, "HAM_binary")
    test_dir = os.path.join(base_dir, "ISIC_binary")
    ...
    torch.save(model.state_dict(), "cross_dataset_model.pth")

    print("Testing on ISIC...")
